"""
Module contenant l'implémentation de la métrique d'erreur quadratique moyenne (Mean Squared Error).
"""
...
class MeanQuadraticError(Metric):
    """
    Métrique d'erreur quadratique moyenne (MSE) pour la régression ou la classification.
    """
    def evaluate(self, y_true, y_pred):
        ...
        Returns:
            L'erreur quadratique moyenne multipliée par 0.5.
        """
    ...
    def gradient(self, y_true, y_pred):
        """
        Calcule le gradient de l'erreur quadratique moyenne par rapport aux prédictions.
        Args:
            y_true: Les valeurs cibles réelles.
            y_pred: Les prédictions du modèle.
        Returns:
